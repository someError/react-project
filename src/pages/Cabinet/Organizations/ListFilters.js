...
class OrganizationsFilter extends Component {
  constructor () {
    super()
    this.state = {
      ...
      {/*<div className='filter-row'>*/}
        {/*<div className={`filter-row__item ${classNames({'active': query.favorite})}`}>*/}
          ...
          {/*>*/}
            ...
            {/*<FormattedMessage id='orgs.favorites' defaultMessage='Избранные организации' />*/}
          {/*</span>*/}
        {/*</div>*/}
      {/*</div>*/}
...
export default injectIntl(OrganizationsFilter)
